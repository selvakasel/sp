...
BEGIN
	...
	BEGIN
		...
		INSERT INTO @listOfIDs (CountVal,NAME)	VALUES ((SELECT count(ReferenceDoctorID) as ReferredFrom FROM referencedoctor WHERE ReferenceDoctorID IS NOT NULL),'Referred From')
		INSERT INTO @listOfIDs (CountVal,NAME) VALUES ((SELECT count(RefClinicName) FROM DischargeSummary WHERE RefClinicName NOT LIKE 'null'),'Referred To')
